...
public class InterceptorHookManager {
    ...
    private Map<String, Set<InterceptorHook>> map = new HashMap<String, Set<InterceptorHook>>();
        ...
        if (names != null) {
            for (String name : names) {
                if (!map.containsKey(name)) {
                    Set<InterceptorHook> list = new HashSet<InterceptorHook>();
    ...
    public Set<InterceptorHook> getInterceptorHook(HandlerMethod handlerMethod) {
        Set<InterceptorHook> interceptorHooks = new HashSet<InterceptorHook>();
