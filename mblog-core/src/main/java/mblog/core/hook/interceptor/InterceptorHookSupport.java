...
public abstract class InterceptorHookSupport implements InterceptorHook {
    ...
    protected void onPreHandle(HttpServletRequest request, HttpServletResponse response,
    ...
    protected void onPostHandle(HttpServletRequest request, HttpServletResponse response,
                                HandlerMethod handler, ModelAndView modelAndView) throws Exception {
        Iterator<Map.Entry<String, InterceptorListener>> it = this.plugins.entrySet().iterator();
        while (it.hasNext()) {
    ...
    protected void onAfterCompletion(HttpServletRequest request, HttpServletResponse response,
    ...
    protected void onAfterConcurrentHandlingStarted(HttpServletRequest request,
