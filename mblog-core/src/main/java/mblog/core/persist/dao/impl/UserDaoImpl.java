...
public class UserDaoImpl extends BaseRepositoryImpl<UserPO> implements UserDao {
    ...
    public List<UserPO> paging(Paging paging, String key) {
        ...
        if (StringUtils.isNotBlank(key)) {
            q.add(Restrictions.or(Restrictions.like("username", key, MatchMode.ANYWHERE),
    ...
    public void identityPost(List<Long> userIds, boolean identity) {
        ...
        Query query = createSQLQuery("update mto_users set posts = posts " + substm
                                     + " where id in (:ids)");
    ...
    public void identityComment(List<Long> userIds, boolean identity) {
        ...
        Query query = createSQLQuery("update mto_users set comments = comments " + substm
                                     + " where id in (:ids)");
        query.setParameterList("ids", userIds);
        query.executeUpdate();
    }
    ...
    public void identityFollow(List<Long> userIds, boolean identity) {
        ...
        Query query = createSQLQuery("update mto_users set follows = follows " + substm
                                     + " where id in (:ids)");
        query.setParameterList("ids", userIds);
        query.executeUpdate();
    }
    ...
    public void identityFans(List<Long> userIds, boolean identity) {
        ...
        Query query = createSQLQuery("update mto_users set fans = fans " + substm
                                     + " where id in (:ids)");
        query.setParameterList("ids", userIds);
        query.executeUpdate();
    }
    ...
    public void identityFavors(List<Long> userIds, boolean identity) {
        ...
        Query query = createSQLQuery("update mto_users set favors = favors " + substm
                                     + " where id in (:ids)");
        query.setParameterList("ids", userIds);
        query.executeUpdate();
    }
